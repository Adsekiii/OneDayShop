...
namespace dotnetShop.Controllers
{
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserID,ProductID")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserID,ProductID")] Cart cart)
        {
            if (id != cart.Id)
            {
                return NotFound();
